...
const Beranda = () => {
  return (
    <div id="home" className="relative min-h-[500px] md:min-h-[600px] overflow-hidden">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left mt-6 md:mt-0 space-y-4">
          ...
          <BoxReveal boxColor={"#38bdf8"} duration={0.5}>
            <p className="text-base sm:text-lg leading-relaxed text-muted-foreground">
              ...
              <span className="text-sky-400 font-semibold">Custom Survival</span>,{" "}
              <span className="text-sky-400 font-semibold">Fishing & Economy</span>,{" "}
              <span className="text-sky-400 font-semibold">Land Protect</span>, dan{" "}
          ...
          <BoxReveal boxColor={"#3b82f6"} duration={1.2}>
            <div className="mt-2 flex flex-wrap justify-center items-center gap-4">
              ...
              <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-lg shadow-md transition duration-300">
                <i className="ri-chat-poll-fill text-white mr-2"></i> Voting Server
              </button>
            </div>
          </BoxReveal>
        </div>
